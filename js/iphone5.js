...
$('#home-button').on('click', function(){
	$("#phone-footer").fadeOut("normal",function(){
		$("#phone-header").slideUp("fast",function(){
			...
			$("#iphone-display").css("background","linear-gradient(#a5e5f7,#d9b8f5)");
			$("#iphone-display").fadeIn();
			$("#phone-header").fadeOut();
			$("#iphone-header").css("background","linear-gradient(#a5e5f7,#d9b8f5)");
			console.log("CLICK ")
		});
	});
});
